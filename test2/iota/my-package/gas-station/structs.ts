...
import {IOTA} from "../../_dependencies/onchain/0x2/iota/structs";
...
export function isAdminAddedEvent(type: string): boolean { type = compressIotaType(type); return type === `${PKG_V1}::gas_station::AdminAddedEvent`; }
...
export class AdminAddedEvent implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: AdminAddedEventFields, ) { this.$fullTypeName = composeIotaType( AdminAddedEvent.$typeName, ...typeArgs ) as `${typeof PKG_V1}::gas_station::AdminAddedEvent`; this.$typeArgs = typeArgs;

 this.gasStation = fields.gasStation;; this.admin = fields.admin; }

 static reified( ): AdminAddedEventReified { return { typeName: AdminAddedEvent.$typeName, fullTypeName: composeIotaType( AdminAddedEvent.$typeName, ...[] ) as `${typeof PKG_V1}::gas_station::AdminAddedEvent`, typeArgs: [ ] as [], isPhantom: AdminAddedEvent.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => AdminAddedEvent.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => AdminAddedEvent.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => AdminAddedEvent.fromBcs( data, ), bcs: AdminAddedEvent.bcs, fromJSONField: (field: any) => AdminAddedEvent.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => AdminAddedEvent.fromJSON( json, ), fromIotaParsedData: (content: IotaParsedData) => AdminAddedEvent.fromIotaParsedData( content, ), fromIotaObjectData: (content: IotaObjectData) => AdminAddedEvent.fromIotaObjectData( content, ), fetch: async (client: IotaClient, id: string) => AdminAddedEvent.fetch( client, id, ), new: ( fields: AdminAddedEventFields, ) => { return new AdminAddedEvent( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromIotaParsedData( content: IotaParsedData ): AdminAddedEvent { if (content.dataType !== "moveObject") { throw new Error("not an object"); } if (!isAdminAddedEvent(content.type)) { throw new Error(`object at ${(content.fields as any).id} is not a AdminAddedEvent object`); } return AdminAddedEvent.fromFieldsWithTypes( content ); }

 static fromIotaObjectData( data: IotaObjectData ): AdminAddedEvent { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isAdminAddedEvent(data.bcs.type)) { throw new Error(`object at is not a AdminAddedEvent object`); }

 return AdminAddedEvent.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return AdminAddedEvent.fromIotaParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: IotaClient, id: string ): Promise<AdminAddedEvent> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching AdminAddedEvent object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isAdminAddedEvent(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a AdminAddedEvent object`); }

 return AdminAddedEvent.fromIotaObjectData( res.data ); }

 }

/* ============================== AdminRemovedEvent =============================== */

export function isAdminRemovedEvent(type: string): boolean { type = compressIotaType(type); return type === `${PKG_V1}::gas_station::AdminRemovedEvent`; }
...
export class AdminRemovedEvent implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: AdminRemovedEventFields, ) { this.$fullTypeName = composeIotaType( AdminRemovedEvent.$typeName, ...typeArgs ) as `${typeof PKG_V1}::gas_station::AdminRemovedEvent`; this.$typeArgs = typeArgs;

 this.gasStation = fields.gasStation;; this.admin = fields.admin; }

 static reified( ): AdminRemovedEventReified { return { typeName: AdminRemovedEvent.$typeName, fullTypeName: composeIotaType( AdminRemovedEvent.$typeName, ...[] ) as `${typeof PKG_V1}::gas_station::AdminRemovedEvent`, typeArgs: [ ] as [], isPhantom: AdminRemovedEvent.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => AdminRemovedEvent.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => AdminRemovedEvent.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => AdminRemovedEvent.fromBcs( data, ), bcs: AdminRemovedEvent.bcs, fromJSONField: (field: any) => AdminRemovedEvent.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => AdminRemovedEvent.fromJSON( json, ), fromIotaParsedData: (content: IotaParsedData) => AdminRemovedEvent.fromIotaParsedData( content, ), fromIotaObjectData: (content: IotaObjectData) => AdminRemovedEvent.fromIotaObjectData( content, ), fetch: async (client: IotaClient, id: string) => AdminRemovedEvent.fetch( client, id, ), new: ( fields: AdminRemovedEventFields, ) => { return new AdminRemovedEvent( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromIotaParsedData( content: IotaParsedData ): AdminRemovedEvent { if (content.dataType !== "moveObject") { throw new Error("not an object"); } if (!isAdminRemovedEvent(content.type)) { throw new Error(`object at ${(content.fields as any).id} is not a AdminRemovedEvent object`); } return AdminRemovedEvent.fromFieldsWithTypes( content ); }

 static fromIotaObjectData( data: IotaObjectData ): AdminRemovedEvent { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isAdminRemovedEvent(data.bcs.type)) { throw new Error(`object at is not a AdminRemovedEvent object`); }

 return AdminRemovedEvent.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return AdminRemovedEvent.fromIotaParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: IotaClient, id: string ): Promise<AdminRemovedEvent> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching AdminRemovedEvent object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isAdminRemovedEvent(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a AdminRemovedEvent object`); }

 return AdminRemovedEvent.fromIotaObjectData( res.data ); }

 }

/* ============================== GasObjectFundsDecreasedEvent =============================== */

export function isGasObjectFundsDecreasedEvent(type: string): boolean { type = compressIotaType(type); return type === `${PKG_V1}::gas_station::GasObjectFundsDecreasedEvent`; }
...
export class GasObjectFundsDecreasedEvent implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: GasObjectFundsDecreasedEventFields, ) { this.$fullTypeName = composeIotaType( GasObjectFundsDecreasedEvent.$typeName, ...typeArgs ) as `${typeof PKG_V1}::gas_station::GasObjectFundsDecreasedEvent`; this.$typeArgs = typeArgs;

 this.gasStation = fields.gasStation;; this.amount = fields.amount; }

 static reified( ): GasObjectFundsDecreasedEventReified { return { typeName: GasObjectFundsDecreasedEvent.$typeName, fullTypeName: composeIotaType( GasObjectFundsDecreasedEvent.$typeName, ...[] ) as `${typeof PKG_V1}::gas_station::GasObjectFundsDecreasedEvent`, typeArgs: [ ] as [], isPhantom: GasObjectFundsDecreasedEvent.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => GasObjectFundsDecreasedEvent.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => GasObjectFundsDecreasedEvent.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => GasObjectFundsDecreasedEvent.fromBcs( data, ), bcs: GasObjectFundsDecreasedEvent.bcs, fromJSONField: (field: any) => GasObjectFundsDecreasedEvent.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => GasObjectFundsDecreasedEvent.fromJSON( json, ), fromIotaParsedData: (content: IotaParsedData) => GasObjectFundsDecreasedEvent.fromIotaParsedData( content, ), fromIotaObjectData: (content: IotaObjectData) => GasObjectFundsDecreasedEvent.fromIotaObjectData( content, ), fetch: async (client: IotaClient, id: string) => GasObjectFundsDecreasedEvent.fetch( client, id, ), new: ( fields: GasObjectFundsDecreasedEventFields, ) => { return new GasObjectFundsDecreasedEvent( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromIotaParsedData( content: IotaParsedData ): GasObjectFundsDecreasedEvent { if (content.dataType !== "moveObject") { throw new Error("not an object"); } if (!isGasObjectFundsDecreasedEvent(content.type)) { throw new Error(`object at ${(content.fields as any).id} is not a GasObjectFundsDecreasedEvent object`); } return GasObjectFundsDecreasedEvent.fromFieldsWithTypes( content ); }

 static fromIotaObjectData( data: IotaObjectData ): GasObjectFundsDecreasedEvent { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isGasObjectFundsDecreasedEvent(data.bcs.type)) { throw new Error(`object at is not a GasObjectFundsDecreasedEvent object`); }

 return GasObjectFundsDecreasedEvent.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return GasObjectFundsDecreasedEvent.fromIotaParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: IotaClient, id: string ): Promise<GasObjectFundsDecreasedEvent> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching GasObjectFundsDecreasedEvent object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isGasObjectFundsDecreasedEvent(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a GasObjectFundsDecreasedEvent object`); }

 return GasObjectFundsDecreasedEvent.fromIotaObjectData( res.data ); }

 }

/* ============================== GasObjectFundsRefilledEvent =============================== */

export function isGasObjectFundsRefilledEvent(type: string): boolean { type = compressIotaType(type); return type === `${PKG_V1}::gas_station::GasObjectFundsRefilledEvent`; }
...
export class GasObjectFundsRefilledEvent implements StructClass { __StructClass = true as const;
 ...
 static fromIotaParsedData( content: IotaParsedData ): GasObjectFundsRefilledEvent { if (content.dataType !== "moveObject") { throw new Error("not an object"); } if (!isGasObjectFundsRefilledEvent(content.type)) { throw new Error(`object at ${(content.fields as any).id} is not a GasObjectFundsRefilledEvent object`); } return GasObjectFundsRefilledEvent.fromFieldsWithTypes( content ); }

 static fromIotaObjectData( data: IotaObjectData ): GasObjectFundsRefilledEvent { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isGasObjectFundsRefilledEvent(data.bcs.type)) { throw new Error(`object at is not a GasObjectFundsRefilledEvent object`); }

 return GasObjectFundsRefilledEvent.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return GasObjectFundsRefilledEvent.fromIotaParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: IotaClient, id: string ): Promise<GasObjectFundsRefilledEvent> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching GasObjectFundsRefilledEvent object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isGasObjectFundsRefilledEvent(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a GasObjectFundsRefilledEvent object`); }

 return GasObjectFundsRefilledEvent.fromIotaObjectData( res.data ); }

 }

/* ============================== GasStation =============================== */

export function isGasStation(type: string): boolean { type = compressIotaType(type); return type === `${PKG_V1}::gas_station::GasStation`; }

export interface GasStationFields { id: ToField<UID>; availableFunds: ToField<Balance<ToPhantom<IOTA>>>; admins: ToField<Vector<"address">>; gasSigner: ToField<"address">; refillToValue: ToField<"u64">; publicKey: ToField<Vector<"u8">> }
...
export class GasStation implements StructClass { __StructClass = true as const;
 ...
 readonly id: ToField<UID>; readonly availableFunds: ToField<Balance<ToPhantom<IOTA>>>; readonly admins: ToField<Vector<"address">>; readonly gasSigner: ToField<"address">; readonly refillToValue: ToField<"u64">; readonly publicKey: ToField<Vector<"u8">>

 private constructor(typeArgs: [], fields: GasStationFields, ) { this.$fullTypeName = composeIotaType( GasStation.$typeName, ...typeArgs ) as `${typeof PKG_V1}::gas_station::GasStation`; this.$typeArgs = typeArgs;
 ...
 static reified( ): GasStationReified { return { typeName: GasStation.$typeName, fullTypeName: composeIotaType( GasStation.$typeName, ...[] ) as `${typeof PKG_V1}::gas_station::GasStation`, typeArgs: [ ] as [], isPhantom: GasStation.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => GasStation.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => GasStation.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => GasStation.fromBcs( data, ), bcs: GasStation.bcs, fromJSONField: (field: any) => GasStation.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => GasStation.fromJSON( json, ), fromIotaParsedData: (content: IotaParsedData) => GasStation.fromIotaParsedData( content, ), fromIotaObjectData: (content: IotaObjectData) => GasStation.fromIotaObjectData( content, ), fetch: async (client: IotaClient, id: string) => GasStation.fetch( client, id, ), new: ( fields: GasStationFields, ) => { return new GasStation( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromFields( fields: Record<string, any> ): GasStation { return GasStation.reified( ).new( { id: decodeFromFields(UID.reified(), fields.id), availableFunds: decodeFromFields(Balance.reified(reified.phantom(IOTA.reified())), fields.available_funds), admins: decodeFromFields(reified.vector("address"), fields.admins), gasSigner: decodeFromFields("address", fields.gas_signer), refillToValue: decodeFromFields("u64", fields.refill_to_value), publicKey: decodeFromFields(reified.vector("u8"), fields.public_key) } ) }
 ...
 return GasStation.reified( ).new( { id: decodeFromFieldsWithTypes(UID.reified(), item.fields.id), availableFunds: decodeFromFieldsWithTypes(Balance.reified(reified.phantom(IOTA.reified())), item.fields.available_funds), admins: decodeFromFieldsWithTypes(reified.vector("address"), item.fields.admins), gasSigner: decodeFromFieldsWithTypes("address", item.fields.gas_signer), refillToValue: decodeFromFieldsWithTypes("u64", item.fields.refill_to_value), publicKey: decodeFromFieldsWithTypes(reified.vector("u8"), item.fields.public_key) } ) }
 ...
 static fromJSONField( field: any ): GasStation { return GasStation.reified( ).new( { id: decodeFromJSONField(UID.reified(), field.id), availableFunds: decodeFromJSONField(Balance.reified(reified.phantom(IOTA.reified())), field.availableFunds), admins: decodeFromJSONField(reified.vector("address"), field.admins), gasSigner: decodeFromJSONField("address", field.gasSigner), refillToValue: decodeFromJSONField("u64", field.refillToValue), publicKey: decodeFromJSONField(reified.vector("u8"), field.publicKey) } ) }
 ...
 static fromIotaParsedData( content: IotaParsedData ): GasStation { if (content.dataType !== "moveObject") { throw new Error("not an object"); } if (!isGasStation(content.type)) { throw new Error(`object at ${(content.fields as any).id} is not a GasStation object`); } return GasStation.fromFieldsWithTypes( content ); }

 static fromIotaObjectData( data: IotaObjectData ): GasStation { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isGasStation(data.bcs.type)) { throw new Error(`object at is not a GasStation object`); }

 return GasStation.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return GasStation.fromIotaParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: IotaClient, id: string ): Promise<GasStation> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching GasStation object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isGasStation(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a GasStation object`); }

 return GasStation.fromIotaObjectData( res.data ); }

 }

/* ============================== GasStationFundsAddedEvent =============================== */

export function isGasStationFundsAddedEvent(type: string): boolean { type = compressIotaType(type); return type === `${PKG_V1}::gas_station::GasStationFundsAddedEvent`; }
...
export class GasStationFundsAddedEvent implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: GasStationFundsAddedEventFields, ) { this.$fullTypeName = composeIotaType( GasStationFundsAddedEvent.$typeName, ...typeArgs ) as `${typeof PKG_V1}::gas_station::GasStationFundsAddedEvent`; this.$typeArgs = typeArgs;

 this.gasStation = fields.gasStation;; this.workspaceId = fields.workspaceId;; this.amount = fields.amount; }

 static reified( ): GasStationFundsAddedEventReified { return { typeName: GasStationFundsAddedEvent.$typeName, fullTypeName: composeIotaType( GasStationFundsAddedEvent.$typeName, ...[] ) as `${typeof PKG_V1}::gas_station::GasStationFundsAddedEvent`, typeArgs: [ ] as [], isPhantom: GasStationFundsAddedEvent.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => GasStationFundsAddedEvent.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => GasStationFundsAddedEvent.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => GasStationFundsAddedEvent.fromBcs( data, ), bcs: GasStationFundsAddedEvent.bcs, fromJSONField: (field: any) => GasStationFundsAddedEvent.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => GasStationFundsAddedEvent.fromJSON( json, ), fromIotaParsedData: (content: IotaParsedData) => GasStationFundsAddedEvent.fromIotaParsedData( content, ), fromIotaObjectData: (content: IotaObjectData) => GasStationFundsAddedEvent.fromIotaObjectData( content, ), fetch: async (client: IotaClient, id: string) => GasStationFundsAddedEvent.fetch( client, id, ), new: ( fields: GasStationFundsAddedEventFields, ) => { return new GasStationFundsAddedEvent( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromIotaParsedData( content: IotaParsedData ): GasStationFundsAddedEvent { if (content.dataType !== "moveObject") { throw new Error("not an object"); } if (!isGasStationFundsAddedEvent(content.type)) { throw new Error(`object at ${(content.fields as any).id} is not a GasStationFundsAddedEvent object`); } return GasStationFundsAddedEvent.fromFieldsWithTypes( content ); }

 static fromIotaObjectData( data: IotaObjectData ): GasStationFundsAddedEvent { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isGasStationFundsAddedEvent(data.bcs.type)) { throw new Error(`object at is not a GasStationFundsAddedEvent object`); }

 return GasStationFundsAddedEvent.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return GasStationFundsAddedEvent.fromIotaParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: IotaClient, id: string ): Promise<GasStationFundsAddedEvent> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching GasStationFundsAddedEvent object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isGasStationFundsAddedEvent(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a GasStationFundsAddedEvent object`); }

 return GasStationFundsAddedEvent.fromIotaObjectData( res.data ); }

 }

/* ============================== GasStationFundsRemovedEvent =============================== */

export function isGasStationFundsRemovedEvent(type: string): boolean { type = compressIotaType(type); return type === `${PKG_V1}::gas_station::GasStationFundsRemovedEvent`; }
...
export class GasStationFundsRemovedEvent implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: GasStationFundsRemovedEventFields, ) { this.$fullTypeName = composeIotaType( GasStationFundsRemovedEvent.$typeName, ...typeArgs ) as `${typeof PKG_V1}::gas_station::GasStationFundsRemovedEvent`; this.$typeArgs = typeArgs;

 this.gasStation = fields.gasStation;; this.amount = fields.amount; }

 static reified( ): GasStationFundsRemovedEventReified { return { typeName: GasStationFundsRemovedEvent.$typeName, fullTypeName: composeIotaType( GasStationFundsRemovedEvent.$typeName, ...[] ) as `${typeof PKG_V1}::gas_station::GasStationFundsRemovedEvent`, typeArgs: [ ] as [], isPhantom: GasStationFundsRemovedEvent.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => GasStationFundsRemovedEvent.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => GasStationFundsRemovedEvent.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => GasStationFundsRemovedEvent.fromBcs( data, ), bcs: GasStationFundsRemovedEvent.bcs, fromJSONField: (field: any) => GasStationFundsRemovedEvent.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => GasStationFundsRemovedEvent.fromJSON( json, ), fromIotaParsedData: (content: IotaParsedData) => GasStationFundsRemovedEvent.fromIotaParsedData( content, ), fromIotaObjectData: (content: IotaObjectData) => GasStationFundsRemovedEvent.fromIotaObjectData( content, ), fetch: async (client: IotaClient, id: string) => GasStationFundsRemovedEvent.fetch( client, id, ), new: ( fields: GasStationFundsRemovedEventFields, ) => { return new GasStationFundsRemovedEvent( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromIotaParsedData( content: IotaParsedData ): GasStationFundsRemovedEvent { if (content.dataType !== "moveObject") { throw new Error("not an object"); } if (!isGasStationFundsRemovedEvent(content.type)) { throw new Error(`object at ${(content.fields as any).id} is not a GasStationFundsRemovedEvent object`); } return GasStationFundsRemovedEvent.fromFieldsWithTypes( content ); }

 static fromIotaObjectData( data: IotaObjectData ): GasStationFundsRemovedEvent { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isGasStationFundsRemovedEvent(data.bcs.type)) { throw new Error(`object at is not a GasStationFundsRemovedEvent object`); }

 return GasStationFundsRemovedEvent.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return GasStationFundsRemovedEvent.fromIotaParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: IotaClient, id: string ): Promise<GasStationFundsRemovedEvent> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching GasStationFundsRemovedEvent object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isGasStationFundsRemovedEvent(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a GasStationFundsRemovedEvent object`); }

 return GasStationFundsRemovedEvent.fromIotaObjectData( res.data ); }

 }

/* ============================== SignatureData =============================== */

export function isSignatureData(type: string): boolean { type = compressIotaType(type); return type === `${PKG_V1}::gas_station::SignatureData`; }
...
export class SignatureData implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: SignatureDataFields, ) { this.$fullTypeName = composeIotaType( SignatureData.$typeName, ...typeArgs ) as `${typeof PKG_V1}::gas_station::SignatureData`; this.$typeArgs = typeArgs;

 this.gasCoinObjectId = fields.gasCoinObjectId;; this.timestamp = fields.timestamp; }

 static reified( ): SignatureDataReified { return { typeName: SignatureData.$typeName, fullTypeName: composeIotaType( SignatureData.$typeName, ...[] ) as `${typeof PKG_V1}::gas_station::SignatureData`, typeArgs: [ ] as [], isPhantom: SignatureData.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => SignatureData.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => SignatureData.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => SignatureData.fromBcs( data, ), bcs: SignatureData.bcs, fromJSONField: (field: any) => SignatureData.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => SignatureData.fromJSON( json, ), fromIotaParsedData: (content: IotaParsedData) => SignatureData.fromIotaParsedData( content, ), fromIotaObjectData: (content: IotaObjectData) => SignatureData.fromIotaObjectData( content, ), fetch: async (client: IotaClient, id: string) => SignatureData.fetch( client, id, ), new: ( fields: SignatureDataFields, ) => { return new SignatureData( [], fields ) }, kind: "StructClassReified", } }
 ...
 static fromIotaParsedData( content: IotaParsedData ): SignatureData { if (content.dataType !== "moveObject") { throw new Error("not an object"); } if (!isSignatureData(content.type)) { throw new Error(`object at ${(content.fields as any).id} is not a SignatureData object`); } return SignatureData.fromFieldsWithTypes( content ); }

 static fromIotaObjectData( data: IotaObjectData ): SignatureData { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isSignatureData(data.bcs.type)) { throw new Error(`object at is not a SignatureData object`); }

 return SignatureData.fromBcs( fromB64(data.bcs.bcsBytes) ); } if (data.content) { return SignatureData.fromIotaParsedData( data.content ) } throw new Error( "Both `bcs` and `content` fields are missing from the data. Include `showBcs` or `showContent` in the request." ); }

 static async fetch( client: IotaClient, id: string ): Promise<SignatureData> { const res = await client.getObject({ id, options: { showBcs: true, }, }); if (res.error) { throw new Error(`error fetching SignatureData object at id ${id}: ${res.error.code}`); } if (res.data?.bcs?.dataType !== "moveObject" || !isSignatureData(res.data.bcs.type)) { throw new Error(`object at id ${id} is not a SignatureData object`); }

 return SignatureData.fromIotaObjectData( res.data ); }
