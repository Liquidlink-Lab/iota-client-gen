...
import * as coinManager from "./coin-manager/structs";
...
import * as systemAdminCap from "./system-admin-cap/structs";
import * as tableVec from "./table-vec/structs";
import * as table from "./table/structs";
import * as timelock from "./timelock/structs";
...
export function registerClasses(loader: StructClassLoader) { loader.register(authenticatorState.ActiveJwk);
...
loader.register(coin.DenyCapV1);
loader.register(coin.RegulatedCoinMetadata);
loader.register(coin.TreasuryCap);
loader.register(coinManager.CoinManaged);
loader.register(coinManager.CoinManager);
loader.register(coinManager.CoinManagerMetadataCap);
loader.register(coinManager.CoinManagerTreasuryCap);
loader.register(coinManager.ImmutableCoinMetadata);
loader.register(coinManager.MetadataOwnershipRenounced);
loader.register(coinManager.TreasuryOwnershipRenounced);
...
loader.register(iota.IOTA);
loader.register(iota.IotaTreasuryCap);
...
loader.register(labeler.LabelerCap);
...
loader.register(systemAdminCap.IotaSystemAdminCap);
loader.register(table.Table);
loader.register(tableVec.TableVec);
loader.register(timelock.TimeLock);
